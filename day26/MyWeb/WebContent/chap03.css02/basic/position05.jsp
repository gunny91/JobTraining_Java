...
<head>
	...
	body{
		...
		#book1{
		 background:url(./../images/bg_sm01.png) no-repeate;
		 position: absolute; 
		 top:50px; 
		 left:0%;
		 }
		 ...
		 #book2{
		 background:url(./../images/bg_sm02.png) no-repeate;
		 position: absolute; 
		 top:50px; 
		 left:50%;
		 }
		 ...
		 #book3{
		 background:url(./../images/bg_sm03.png) no-repeate;
		 position: absolute; 
		 top:100px; 
		 left:0%;
		 }
		 ...
		 #book4{
		 background:url(./../images/bg_sm04.png) no-repeate;
		 position: absolute; 
		 top:100px; 
		 left:50%;
		 }
